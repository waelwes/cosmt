...
('Anti-Aging Night Cream', 'Elite Skincare', 'Skincare', 95.00, 120.00, 23, 'active', 4.9, 156, '/api/placeholder/300/300', true, true, 'Advanced anti-aging night cream with retinol'),
('Hair Shampoo - Volumizing', 'Volume Pro', 'Hair Care', 35.75, NULL, 67, 'active', 4.3, 89, '/api/placeholder/300/300', false, false, 'Volumizing shampoo for fine hair');
