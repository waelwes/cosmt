-- Create payment_gateways table for managing multiple payment providers
...
INSERT INTO payment_gateways (name, display_name, provider, is_active, is_default, mode, description, supported_currencies, supported_countries) VALUES
