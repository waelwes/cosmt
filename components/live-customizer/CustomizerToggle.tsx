            ...
            <div style={{ display: 'flex', borderBottom: '1px solid #e5e7eb', backgroundColor: 'white' }} className="live-customizer-tabs">
              <button
                style={{
                  ...
                  borderBottom: activeTab === 'sections' ? '2px solid #00514B' : '2px solid transparent',
                  cursor: 'pointer',
                  fontSize: '14px',
                  fontWeight: '500',
                  color: activeTab === 'sections' ? '#00514B' : '#6b7280',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <button
                style={{
                  ...
                  borderBottom: activeTab === 'design' ? '2px solid #00514B' : '2px solid transparent',
                  cursor: 'pointer',
                  fontSize: '14px',
                  fontWeight: '500',
                  color: activeTab === 'design' ? '#00514B' : '#6b7280',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '6px'
